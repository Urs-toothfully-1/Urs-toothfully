    ...
    <div className="space-y-1">
      <label className="flex items-center gap-2.5 cursor-pointer group">
        <input
          ...
          className="h-4 w-4 rounded accent-[#4ABCC8]"
        />
        <span className="text-sm group-hover:text-[#4ABCC8] transition-colors" style={{ color: BRAND_COLORS.bodyText }}>
          {label}
        </span>
      </label>
      {checked && children && (
...
const inputClass = "h-9 border-[#CCCCCC] focus-visible:ring-[#4ABCC8] text-sm bg-[#EBECEE] mt-1"
const taClass = "border-[#CCCCCC] focus-visible:ring-[#4ABCC8] text-sm bg-[#EBECEE] resize-none"
      ...
      >
        ...
        <label className="flex items-start gap-3 cursor-pointer">
          <input
            ...
            className="h-4 w-4 mt-0.5 accent-[#4ABCC8]"
          />
